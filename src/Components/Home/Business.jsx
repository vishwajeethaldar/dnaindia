...
export const Business = () => {
  ...
  return (
    ...
    <SkeletonText isLoaded={!state.isDataLoading}>
        ...
        <Box as={'h1'} bg="#eee" py="5px"  my="10px" pl="10px"fontSize={['1.2em', '1.4em', '2.8em']} borderBottom="'1px solid #000" mb="5px"> Business </Box>        
        <Box>
            <Card data={data} link="/business" text="More Business news"/>
        </Box>
    </SkeletonText>
  )
}
