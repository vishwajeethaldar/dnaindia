...
export const India = () => {
  ...
  return (
    ...
    <SkeletonText isLoaded={!state.isDataLoading}>
        ...
        <Box as={'h1'} bg="#eee" py="5px"  my="10px" pl="10px"fontSize={['1.4em', '1.4em', '1.4em']} borderBottom="'1px solid #000" mb="5px"> India </Box>        
        <Box>
            <Card data={data} link="/india" text="More India news"/>
        </Box>
    </SkeletonText>
  )
}
